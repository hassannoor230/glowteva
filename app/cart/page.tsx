    ...
    <div className="pt-28 pb-20">
      <div className="container-luxury max-w-4xl">
          ...
          {items.map((item) => (
            <div key={item.product._id} className="flex gap-6 py-6 border-b border-soft-border">
              ...
              <div className="flex-1">
                <Link href={`/products/${item.product.slug}`} className="font-medium text-forest hover:text-gold">
                  {item.product.name}
                </Link>
        ...
        <div className="max-w-sm ml-auto space-y-3">
          ...
          <div className="flex justify-between font-medium text-lg border-t border-soft-border pt-3">
