        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="space-y-8">
            <div className="card-luxury overflow-hidden">
              <div className="aspect-[4/3] w-full">
                <iframe
                  ...
                  title="GlowTeva Organics Location"
                />
              </div>
            </div>
            ...
            <div className="card-luxury p-6 md:p-8">
              ...
              <p className="text-soft-green leading-relaxed">{contactInfo.address}</p>
            </div>
            ...
            <div className="card-luxury p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
                ...
                <div>
                  ...
                  />
                  {errors.subject && (
                    <p id="subject-error" className="text-red-600 text-xs mt-1" role="alert">{errors.subject.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.message && (
                    <p id="message-error" className="text-red-600 text-xs mt-1" role="alert">{errors.message.message}</p>
                  )}
                </div>

                {msg && (
                  <p
                    className={`text-sm ${status === 'success' ? 'text-soft-green' : 'text-red-600'}`}
                    role="alert"
                    aria-live="polite"
                  >
                    {msg}
                ...
                <div className="flex gap-3">
                  {contactInfo.socialLinks.map((social, i) => (
                    <a
                      ...
                      className="w-10 h-10 rounded-lg border border-soft-border/60 flex items-center justify-center text-forest hover:bg-forest hover:text-cream hover:border-forest transition-all duration-300"
                    >
